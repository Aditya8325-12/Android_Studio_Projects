...
public class Test_instrucation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String query="?t1=Test_question&t2="+Test_list.testInfo.get(test_postion).getTest_id();
        ...
        start_test.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  Toast.makeText(Test_instrucation.this, "length"+question.size(), Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for(int i=0;i< jsonArray.length();i++)
                {
                    ...
                    String correct=(String) jsonObject.get("correct_answer");
