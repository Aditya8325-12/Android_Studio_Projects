...
public class CreateAPieChartLayout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_apie_chart_layout);


        linearLayout=findViewById(R.id.linear);
        ArrayList<PieEntry> pieEntries=myobj.getValues();

        PieChart pieChart=new PieChart(CreateAPieChartLayout.this);
